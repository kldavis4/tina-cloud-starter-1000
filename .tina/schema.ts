...
const apiURL =
  process.env.NODE_ENV == "development"
    ...
    : `https://content.tinajs.io/content/7427d997-ae2b-4004-8f4f-f8d07d34faf7/github/main`;

export const tinaConfig = defineConfig({
  // apiURL: `https://content.tinajs.io/content/7427d997-ae2b-4004-8f4f-f8d07d34faf7/github/main`,
  apiURL,
  mediaStore: async () => {
